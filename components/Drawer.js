      ...
      <aside className="flex flex-col justify-between border-r border-base-200 bg-base-100 text-base-content w-80">
        <div>
          <ul className="menu flex flex-col p-4 pt-2 compact">
            ...
            <li>
              <a href="/docs/install" className="capitalize">
                <svg
            ...
            <li>
              <a href="/docs/use" className="capitalize">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a href="/docs/customize" className="capitalize">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a href="/docs/default-themes" className="capitalize">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a href="/docs/config" className="capitalize">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a href="/core/colors" className="capitalize">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a href="/core/layout" className="capitalize">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
