...
const termsOfUse = ({ URL }) => {
  return (
    <>
      <Seo
        title="Terms Of Use"
        description="The CHEMCASTS website is a copyrighted work belonging to
    CHEMCASTS. Certain features of the Site may be subject to
    additional guidelines, terms, or rules, which will be posted on
    the Site in connection with such features."
        twTitle="Terms Of Use"
        twDescription="The CHEMCASTS website is a copyrighted work belonging to
    CHEMCASTS. Certain features of the Site may be subject to
    additional guidelines, terms, or rules, whiफ़ch will be posted on
    the Site in connection with such features."
        twImage="/png/privacy-protection.png"
        ogTitle="Terms Of Use"
        ogDescription="The CHEMCASTS website is a copyrighted work belonging to
    CHEMCASTS. Certain features of the Site may be subject to
    additional guidelines, terms, or rules, which will be posted on
    the Site in connection with such features."
      ...
      >
        <div className="px-4 sm:px-6 xl:px-8 pt-2 pb-2">
            ...
            <ol className="flex leading-none text-3xl text-brand font-bold divide-x divide-brand-400">
              ...
              <li>
                <Link href="/legal/terms-of-use">
                  <a className="px-2 text-brand font-semibold">Terms Of Use</a>
                </Link>
              </li>
            </ol>
          </nav>
          <div className="prose prose-brand lg:prose-lg xl:prose-xl">
            ...
            <p>
              The CHEMCASTS website is a copyrighted work belonging to
              CHEMCASTS. Certain features of the Site may be subject to
              additional guidelines, terms, or rules, which will be posted on
              the Site in connection with such features.
            </p>
            ...
            <p>
              ...
              Terms. YOU SHOULD BE AT LEAST 18 YEARS OF AGE TO ACCESS THE SITE.
              IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT
            ...
            <p>
              ...
              yourself to liability. Company is not obliged to backup any User
              Content that you post; also, your User Content may be deleted at
              any time without prior notice to you. You are solely responsible
              for making your own backup copies of your User Content if you
              desire.
            </p>
            ...
            <p>
              ...
              the Site. You hereby irreversibly waive any claims and assertions
            ...
            <p>
              ...
              any kind against any group or individual; (iii) that is harmful to
            ...
            <p>
              ...
              believes appropriate. Company will treat any Feedback you provide
            ...
            <p>
              ...
              or (d) your User Content. Company reserves the right to assume the
            ...
            <p>
              ...
              CHEMCASTS uses ‘cookies’. These cookies are used to store
            ...
            <p>
              ...
              and use the Site will terminate immediately. You understand that
            ...
            <p>
              ...
              Ahmedabad,Gujarat,India. After the Notice is received, you and the
              ...
              begin an arbitration proceeding. The amount of any settlement
            ...
            <p>
              ...
              law any information necessary to enforce this Agreement, to
            ...
            <p>
              ...
              by the party against whom the claim is asserted. Such waiver shall
            ...
            <p>
              ...
              on the Site are our property or the property of other
